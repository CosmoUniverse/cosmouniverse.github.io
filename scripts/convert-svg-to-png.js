...
async function convertSvgToPng() {
    try {
        // Read SVG file
        const svgData = fs.readFileSync(path.join(assetsDir, 'background-pattern.svg'), 'utf8');
        ...
        fs.writeFileSync(path.join(assetsDir, 'background-pattern.png'), buffer);
        console.log('✓ PNG file created: assets/background-pattern.png (1200x1200px)');
        ...
        fs.writeFileSync(path.join(assetsDir, 'background-pattern-tile.png'), smallBuffer);
        console.log('✓ Tile PNG created: assets/background-pattern-tile.png (120x120px)');
